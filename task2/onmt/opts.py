...
def model_opts(parser):
    ...
    group.add('--refer', '-refer', action="store_true",
              help="""Have an additional encoder to pay attention to.""")
    ...
    group.add('--input_feed', '-input_feed', type=int, default=0,
    ...
    group.add('--co_attn', '-co_attn', action="store_true",
              help='Train co-attention layer.')
...
def preprocess_opts(parser):
    ...
    group.add('--train_ref', '-train_ref', required=False,
              help="Path to the training reference data")
    group.add('--train_tgt', '-train_tgt', required=True,
              help="Path to the training target data")
    group.add('--valid_src', '-valid_src', required=True,
              help="Path to the validation source data")
    group.add('--valid_ref', '-valid_ref', required=False,
              help="Path to the validation reference data")
    ...
    group.add('--src_vocab', '-src_vocab', default="",
              help="""Path to an existing source vocabulary. Format:
                       one word per line.""")
    group.add('--ref_vocab', '-ref_vocab', default="",
              help="""Path to an existing source vocabulary. Format:
                       one word per line.""")
    ...
    group.add('--ref_vocab_size', '-ref_vocab_size', type=int, default=50000,
    ...
    group.add('--ref_words_min_frequency',
              '-ref_words_min_frequency', type=int, default=0)
    ...
    group.add('--ref_seq_length', '-ref_seq_length', type=int, default=10000,
              help="Maximum source sequence length")
    group.add('--src_seq_length_trunc', '-src_seq_length_trunc',
              type=int, default=0,
              help="Truncate source sequence length.")
    group.add('--ref_seq_length_trunc', '-ref_seq_length_trunc',
              type=int, default=0,
              help="Truncate source sequence length.")
...
def train_opts(parser):
    ...
    group.add('--mask_attention', '-mask_attention', action='store_true',
              help="Apply multi-attention by masked attention.")
    group.add('--mask_path', '-mask_path',
              help="Masks for mask attention.")
...
def translate_opts(parser):
    ...
    group.add('--refer', '-refer', action="store_true",
              help="Use refer")
    group.add('--ref_path', '-ref_path', default="")
    group.add('--lower', '-lower', action="store_true", help="Lowercase source.")
    ...
    group.add('--max_sent_length', '-max_sent_length', type=int, default=400,
