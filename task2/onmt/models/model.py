...
class NMTModel(nn.Module):
    ...
    def forward(self, src, tgt, lengths, ref=None, masks=None):
        ...
        if ref:
            ...
            ref_state, ref_bank, ref_lengths = self.refer(sorted_ref, ref_lengths)
        ...
        dec_out, attns = self.decoder(tgt, memory_bank,
                                      memory_lengths=lengths, ref=ref_tuple, masks=masks)
